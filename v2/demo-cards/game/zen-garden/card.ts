...
export default defineCard({
  ...
  inputs: {
    seed: {
      ...
      required: false,
      description:
        'Seed for deterministic stone placement (e.g. "2026-02-10"). Same seed = same garden layout. Defaults to today\'s date for a daily garden.',
    },
  },
    ...
    saveStrokes: {
      ...
      inputs: {
        strokes: {
          ...
          required: true,
          description:
            'JSON array of stroke arrays, each stroke is an array of {x,y} normalized points',
        },
      },
